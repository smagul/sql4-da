...
they paid (total_amt_usd/total) for the order. Your final table should have 3 columns: region name, account 
name, and unit price. A few accounts have 0 for total, so I divided by (total + 0.01) to assure not dividing by zero.
*/

/* ===== 1 ===== */
SELECT a.primary_poc, w.occurred_at, w.channel, a.name AS Walmart
