...
/* 2. Find the total sales in usd for each account. You should include 
...
/* 7. Find the number of sales reps in each region. Your final table should have two columns - the 
